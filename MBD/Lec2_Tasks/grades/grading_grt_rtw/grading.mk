...
## 
## Makefile     : grading.mk
## Generated on : Sat Jan 07 17:14:02 2023
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/grading_grt_rtw -I$(START_DIR) -IE:/iTi embedded systems/matlab_banna/repo_git/MBD/Lec2_Tasks/grades -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=grading -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/grading_grt_rtw/grading.c $(START_DIR)/grading_grt_rtw/grading_data.c $(START_DIR)/grading_grt_rtw/rtGetInf.c $(START_DIR)/grading_grt_rtw/rtGetNaN.c $(START_DIR)/grading_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = grading.obj grading_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/grading_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
