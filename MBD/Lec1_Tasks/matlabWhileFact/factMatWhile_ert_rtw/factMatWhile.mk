###########################################################################
## Makefile generated for Simulink model 'factMatWhile'. 
## 
## Makefile     : factMatWhile.mk
## Generated on : Tue Jan 10 23:17:38 2023
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/factMatWhile.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = factMatWhile_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = factMatWhile_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/factMatWhile.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/factMatWhile_ert_rtw -I$(START_DIR) -IE:/iTi/matlab_banna/repo_git/MBD/Lec1_Tasks/matlabWhileFact -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=factMatWhile -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/factMatWhile_ert_rtw/factMatWhile.c

MAIN_SRC = $(START_DIR)/factMatWhile_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/factMatWhile_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
