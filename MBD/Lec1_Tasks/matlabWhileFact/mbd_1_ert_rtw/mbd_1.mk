###########################################################################
## Makefile generated for Simulink model 'mbd_1'. 
## 
## Makefile     : mbd_1.mk
## Generated on : Sat Jan 07 15:27:04 2023
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mbd_1.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/iTi embedded systems/matlab_banna/repo_git/MBD/Lec1_Tasks/matlabWhileFact
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = mbd_1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = mbd_1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mbd_1.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/mbd_1_ert_rtw -I$(START_DIR) -IE:/iTi embedded systems/matlab_banna/repo_git/MBD/Lec1_Tasks/ProgrammingCalc -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mbd_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/mbd_1_ert_rtw/mbd_1.c

MAIN_SRC = $(START_DIR)/mbd_1_ert_rtw/ert_main.c
