###########################################################################
## Makefile generated for Simulink model 'ledTrigger'. 
## 
## Makefile     : ledTrigger.mk
## Generated on : Tue Jan 10 23:46:24 2023
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ledTrigger.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = ledTrigger_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = ledTrigger_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ledTrigger.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/ledTrigger_ert_rtw -I$(START_DIR) -IE:/iTi/matlab_banna/repo_git/MBD/Lec4_Tasks/ledTrigger -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ledTrigger -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/ledTrigger_ert_rtw/ledTrigger.c $(START_DIR)/ledTrigger_ert_rtw/rt_zcfcn.c

MAIN_SRC = $(START_DIR)/ledTrigger_ert_rtw/ert_main.c
...
OBJS = ledTrigger.obj rt_zcfcn.obj
...
%.obj : $(START_DIR)/ledTrigger_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
